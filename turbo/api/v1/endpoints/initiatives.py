...
async def get_initiatives(
    ...
    try:
        ...
        if workspace and workspace != "all":
            ...
            return await initiative_service.get_initiatives_by_project(
                project_id, sort_by=sort_by, sort_order=sort_order
            )
        elif status_filter:
            return await initiative_service.get_initiatives_by_status(
                status_filter, sort_by=sort_by, sort_order=sort_order
            )
        else:
            return await initiative_service.get_all_initiatives(
